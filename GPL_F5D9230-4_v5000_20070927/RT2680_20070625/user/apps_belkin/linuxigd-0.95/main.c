...
// End Daemon initialization
	...
	trace(2, "Setting the Web Server Root Directory to %s",g_vars.xmlPath);
	...
	trace(2, "Registering the root device with descDocUrl %s", descDocUrl);
