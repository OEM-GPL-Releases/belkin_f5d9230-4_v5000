...
{
	DEBUGP("\n(%s)orig->dst.u.gre.protocol %x orig->dst.u.gre.version %x orig->src.u.gre.key %x orig->dst.u.gre.key %x\n"
	               ,__FUNCTION__,orig->dst.u.gre.protocol,orig->dst.u.gre.version,orig->src.u.gre.key,orig->dst.u.gre.key);
	...
	DEBUGP("(%s)tuple->dst.u.gre.protocol %x tuple->dst.u.gre.version %x tuple->dst.u.gre.key %x tuple->src.u.gre.key %x\n"
	               ,__FUNCTION__,tuple->dst.u.gre.protocol,tuple->dst.u.gre.version,tuple->dst.u.gre.key,tuple->src.u.gre.key);
	
	DEBUGP("(%s)After invert \n", __FUNCTION__);
