	...
	u_int16_t peer_callid)
{
  ...
  DEBUGP("%s: %s %d sizeof(exp.mask)=%d \n" , __FILE__ , __FUNCTION__ , __LINE__,sizeof(exp.mask) );
	...
	exp.mask.src.u.gre.key = 0xffffffff;
