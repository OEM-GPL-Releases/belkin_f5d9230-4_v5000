 ...
 *
 *	$Id: br_stp_if.c,v 1.1.1.1 2006-10-13 02:42:51 steven Exp $
 *
...
{
	unsigned char *addr;
// +++ Gemtek, Make bridge use the first interface's MAC 
	unsigned char *first_ifaddr;
// --- Gemtek, Make bridge use the first interface's MAC
...
*/
	if (memcmp(br->bridge_id.addr, first_ifaddr, ETH_ALEN))
		br_stp_change_bridge_id(br, first_ifaddr);
// --- Gemtek, Make bridge use the first interface's MAC	
