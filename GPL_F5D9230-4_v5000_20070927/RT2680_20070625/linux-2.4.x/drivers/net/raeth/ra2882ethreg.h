...
#define FE_DMA_GLO_CFG		(RA2882ETH_BASE+RAFRAMEENGINE_OFFSET+0x08)
...
#define FC_DROP_STA		(RA2882ETH_BASE+RAFRAMEENGINE_OFFSET+0x18)
...
#define GDMA1_SHRP_CFG		(RA2882ETH_BASE+RAGDMA_OFFSET+0x08)
#define GDMA1_MAC_ADRL		(RA2882ETH_BASE+RAGDMA_OFFSET+0x0C)
#define GDMA1_MAC_ADRH		(RA2882ETH_BASE+RAGDMA_OFFSET+0x10)


/* 3. PSE */
#define PSE_FQFC_CFG		(RA2882ETH_BASE+RAPSE_OFFSET+0x00)
#define GDMA1_FC_CFG		(RA2882ETH_BASE+RAPSE_OFFSET+0x04)
#define GDMA_FC_CFG		(RA2882ETH_BASE+RAPSE_OFFSET+0x0C)
...
#define RT2880_GDMA_RELATED        0x0020
#define RT2880_GDMA1_FWD_CFG       (RT2880_GDMA_RELATED + 0x00)

#define RT2880_GDMA1_SCH_CFG       (RT2880_GDMA_RELATED + 0x04)
#define RT2880_GDMA1_SHRP_CFG      (RT2880_GDMA_RELATED + 0x08)
#define RT2880_GDMA1_MAC_ADRL      (RT2880_GDMA_RELATED + 0x0C)
#define RT2880_GDMA1_MAC_ADRH      (RT2880_GDMA_RELATED + 0x10)


#define RT2880_PSE_RELATED         0x0040
#define RT2880_PSE_FQFC_CFG        (RT2880_PSE_RELATED + 0x00)
#define RT2880_GDMA1_FC_CFG        (RT2880_PSE_RELATED + 0x04)
#define RT2880_CDMA_FC_CFG         (RT2880_PSE_RELATED + 0x0C)
#define RT2880_CDMA_OQ_STA         (RT2880_PSE_RELATED + 0x10)
#define RT2880_GDMA1_OQ_STA        (RT2880_PSE_RELATED + 0x14)
#define RT2880_PPE_OQ_STA          (RT2880_PSE_RELATED + 0x18)
#define RT2880_PSE_IQ_STA          (RT2880_PSE_RELATED + 0x1C)
#define RT2880_FQ_STA              (RT2880_PSE_RELATED + 0x20)
...
/* Ethernet chip registers.PALMCHIP
 */


#define PALM_ETH_BASE		0xA0301C00

/* MAC Registers */
#define PALM_ETH_MACCFG		0x000
#define PALM_ETH_MACADRHI	0x004
#define PALM_ETH_MACADRLO	0x008
#define PALM_ETH_MIICTL		0x014
#define PALM_ETH_MIIDATA	0x018

/* DMA Registers */
#define PALM_ETH_DMACFG		0x100		/* Bus Mode Register */
#define PALM_ETH_TXPOLL		0x104		/* Transmit Poll Demand Reg */
#define PALM_ETH_RXPOLL		0x108		/* Receive Poll Demand Reg */
#define PALM_ETH_RXDESC		0x10C		/* RX Ring Base Address Reg */
#define PALM_ETH_TXDESC		0x110		/* TX Ring Base Address Reg */
#define PALM_ETH_DMASTAT	0x114		/* Status Register */
#define PALM_ETH_DMACTL		0x118		/* DMA Control Register */
...
typedef struct MACInfo_s
{
        ...
        unsigned int phy_tx_ring, phy_rx_ring;
